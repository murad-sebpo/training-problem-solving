...
public class ExtractWebsiteUsingPostMethodWithParam {
    ...
    public ExtractWebsiteUsingPostMethodWithParam() {
...
//        httpPost.addHeader("Content-Length", "180");
        ...
        httpPost.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36");
    }
